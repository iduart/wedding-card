  ...
  return (
    <Main>
      ...
      <ConfirmAttendanceContainer id="attendance">
        <ConfirmAttendance>
          <div className="attendance-text">Acompáñanos en nuestro gran día</div>
          <button className="attendance-button">CONFIRMAR ASISTENCIA</button>
        </ConfirmAttendance>
      </ConfirmAttendanceContainer>
      <Gifts id="gifts">
        <Flowers2 />
        ...
        <GiftsInfoContainer>
          <GiftHeader />
          <GiftTextContainer>
            Ese día tendremos un lugar específico para que deposites tu obsequio
            y nos regales unas palabras para nuestro nuevo hogar
          </GiftTextContainer>
        </GiftsInfoContainer>
      </Gifts>
      <LocationHeaderContainer>
